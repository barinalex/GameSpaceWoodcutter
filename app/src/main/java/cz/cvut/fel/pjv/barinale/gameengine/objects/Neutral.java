...
public class Neutral extends GameObject implements View.OnClickListener {
    ...
    public Neutral(ArrayList<Bitmap> images, ArrayList<GameObject> inventory, Point mapCoordinates, int[] characteristics, int[] initialCharacteristics, String name, int type) {
